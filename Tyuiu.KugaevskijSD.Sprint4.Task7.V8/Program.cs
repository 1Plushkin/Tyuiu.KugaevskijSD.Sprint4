...
namespace Tyuiu.KugaevskijSD.Sprint4.Task7.V8;
    public class Program
{
    static void Main(string[] args)
    {
        ...
        Console.Title = "Спринт #4 | Выполнила: Кугаевский С. Д. | АСОиУб-25-1";
        Console.WriteLine("---------------------------------------------------------------------------");
        ...
        Console.WriteLine("- матрицу 3 на 4 и подсчитайте произведение нечетных чисел в матрице.     -");
        Console.WriteLine("-                                                                         -");
        Console.WriteLine("---------------------------------------------------------------------------");
