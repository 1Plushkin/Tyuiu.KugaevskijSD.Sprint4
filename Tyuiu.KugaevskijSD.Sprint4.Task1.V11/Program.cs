...
using Tyuiu.KugaevskijSD.Sprint4.Task1.V11.Lib;

namespace Tyuiu.KugaevskijSD.Sprint4.Task1.V11;
    internal class Program
{
    static void Main(string[] args)
    {
        DataService ds = new DataService();
        Console.WriteLine("Спринт #4 | Выполнил: Кугаевский С. Д. | АСОиУб-25-1");
        Console.WriteLine("---------------------------------------------------------------------------");
